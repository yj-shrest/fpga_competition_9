...
module tb_edge_encoder_layer;
    ...
    initial begin
        ...
        input_features[0] = 8'b01011010;
        input_features[1] = 8'b10000000;

        $display("========================================");
        $display("Edge Encoder Layer Testbench");
        $display("========================================");
        $display("Parameters:");
    ...
    initial begin
        $dumpfile("edge_encoder_layer_tb.vcd");
        $dumpvars(0, tb_edge_encoder_layer);
    end
