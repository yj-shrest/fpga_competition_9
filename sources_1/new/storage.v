...
(
    ...
    input [RAM_ADDR_BITS_FOR_EDGE-1:0] connectivity_src_addr,
    output [RAM_ADDR_BITS_FOR_NODE-1:0] connectivity_src_data,
    
    // Destination connectivity
    input connectivity_dst_re,
    input [RAM_ADDR_BITS_FOR_EDGE-1:0] connectivity_dst_addr,
    output [RAM_ADDR_BITS_FOR_NODE-1:0] connectivity_dst_data,
...
bram_dual #(
    ...
    .we_a(1'b0),
    .en_a(1'b0),
    .addr_a({RAM_ADDR_BITS_FOR_EDGE{1'b0}}),
